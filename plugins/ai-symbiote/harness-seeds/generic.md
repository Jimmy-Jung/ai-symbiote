...
[Seed #S6] When the user rejects a change ("doesn't work", "wrong", "revert"), log it with: bash "${CURSOR_PLUGIN_ROOT:-${CLAUDE_PLUGIN_ROOT:-${CODEX_PLUGIN_ROOT:-${AI_SYMBIOTE_ROOT:-$HOME/plugins/ai-symbiote}}}}/hooks/scripts/feedback-logger.sh" "<file_path>" "<rejection_reason>" "<what_to_do_differently>"
