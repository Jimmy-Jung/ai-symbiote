...
flowchart TD
    ...
    style T1 fill:#dbeafe,stroke:#1d4ed8,color:#111827
    style T2 fill:#fef3c7,stroke:#b45309,color:#111827
    style C fill:#e5e7eb,stroke:#6b7280,color:#111827
    style PC fill:#dbeafe,stroke:#1d4ed8,color:#111827
    style D fill:#e5e7eb,stroke:#6b7280,color:#111827
    style E fill:#fee2e2,stroke:#b91c1c,color:#111827
    style D2 fill:#e5e7eb,stroke:#6b7280,color:#111827
    style DISP fill:#dbeafe,stroke:#1d4ed8,color:#111827
    style CP fill:#fee2e2,stroke:#b91c1c,color:#111827
    style GG fill:#fee2e2,stroke:#b91c1c,color:#111827
    style D3 fill:#e5e7eb,stroke:#6b7280,color:#111827
    style MH fill:#fee2e2,stroke:#b91c1c,color:#111827
    style F fill:#e5e7eb,stroke:#6b7280,color:#111827
    style GT fill:#dbeafe,stroke:#1d4ed8,color:#111827
    style F2 fill:#e5e7eb,stroke:#6b7280,color:#111827
    style UT fill:#dbeafe,stroke:#1d4ed8,color:#111827
    style F3 fill:#e5e7eb,stroke:#6b7280,color:#111827
    style G fill:#fef3c7,stroke:#b45309,color:#111827
    style F4 fill:#e5e7eb,stroke:#6b7280,color:#111827
    style MF fill:#fee2e2,stroke:#b91c1c,color:#111827
    style S fill:#e5e7eb,stroke:#6b7280,color:#111827
    style CT fill:#dbeafe,stroke:#1d4ed8,color:#111827
    style IO fill:#dbeafe,stroke:#1d4ed8,color:#111827
