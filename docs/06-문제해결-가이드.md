...
flowchart TD
    ...
    style A fill:#fee2e2,stroke:#b91c1c,color:#111827
...
| Cursor 설치 후 플러그인이 안 보임 | `platforms/cursor/install.sh`, `~/.cursor/plugins/local/ai-symbiote`, Cursor 재시작 또는 `Developer: Reload Window` |
