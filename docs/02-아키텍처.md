...
| hooks 이벤트명 | PascalCase (`PreToolUse`) | PascalCase (`PreToolUse`) | camelCase (`preToolUse`) |
| hooks 매처 | `Bash`, `Read\|Skill`, `Write\|Edit` | `Bash` 중심 | `Shell`, `Read`, `Write` |
