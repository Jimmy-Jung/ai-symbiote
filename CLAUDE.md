...
5. `plugins/ai-symbiote/.claude-plugin/plugin.json` — `"version"` field
6. `.claude-plugin/marketplace.json` — `"version"` field
7. `docs/02-아키텍처.md` — `현재 버전:` line
8. `CHANGELOG.md` — add `## [x.y.z] - YYYY-MM-DD` section with release notes
